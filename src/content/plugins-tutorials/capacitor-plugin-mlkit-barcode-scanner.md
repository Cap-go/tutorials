```markdown
---
"title": "Using Biso GmbH Capacitor Plugin ML Kit Barcode Scanner Package"
...
This tutorial will guide you through the process of utilizing the @biso_gmbh/capacitor-plugin-ml-kit-barcode-scanner package for barcode scanning with ML Kit.

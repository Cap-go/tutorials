...
const brand = 'Capgo'
const blogTitle = `Capacitor Blog | ${brand}`
const blogDescription = `The best articles to enhance your Capacitor app. Do more with Capacitor and ${brand}. Learn how to build a modern app with Capacitor.`

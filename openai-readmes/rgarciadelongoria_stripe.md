...
| **`cfCartInfo`**                    | <code>[{ masterBox: string; numMasterBoxes: number; selectedDate: string; type: string; up: string; }]</code> |
| **`cfCountryError`**                | <code>string</code>                                                                                           |
| **`cfAuthorization`**               | <code>string</code>                                                                                           |
